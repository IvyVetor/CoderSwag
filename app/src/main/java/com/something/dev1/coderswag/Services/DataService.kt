package com.something.dev1.coderswag.Services

import com.something.dev1.coderswag.Model.Category
import com.something.dev1.coderswag.Model.Product
...
object DataService {
    ...
    val hoodies = listOf(
            ...
            Product("Devslopes Black Hoodie", "$32", "hood04")
    )
